                    ...
                    <x-jet-validation-errors class="mb-4" />
                        <form class="form-stl" action="{{route('register')}}" name="frm-login" method="POST" >
                            ...
                            <fieldset class="wrap-input">
                                ...
                                <input type="text" id="frm-reg-phone" name="phone"  :value="phone" placeholder="Your mobile number..." required>
                            </fieldset>
                            <fieldset class="wrap-input">
                                <label for="frm-reg-utype">Account Type</label>
                                <select name="utype" id="frm-reg-utype" class="form-control">
                                    <option value="">--Account Type--</option>
                                    <option value="STD">Student</option>
                                    <option value="BOW">Business Owner</option>
                                    <option value="SADM">School Admin</option>
