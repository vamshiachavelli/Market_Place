      ...
      <div class="modal-body">
        <form action="">
            <div class="form-group">
                ...
                <input type="text" name="firstname" class="form-control" wire:model.defer="firstname">
                @error('firstname') <span class="text-danger">{{$message}}</span> @enderror
            </div>
            <div class="form-group">
                <label for="">Lastname</label>
                <input type="text" name="lastname" class="form-control" wire:model.defer="lastname">
