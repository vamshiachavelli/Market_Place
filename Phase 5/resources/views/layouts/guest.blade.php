							...
							<ul>
								@if(Route::has('login'))
									...
									<ul class="submenu curency" >
										<li class="menu-item" >
											<a title="Dashboard" href="{{ route('superadmin.dashboard') }}">Dashboard</a>
										</li>
										<li class="menu-item" >
									...
									<ul class="submenu curency" >
										<li class="menu-item" >
											<a title="Dashboard" href="{{ route('businessowner.dashboard') }}">Dashboard</a>
										</li>
										<li class="menu-item" >
											<a title="Profile" href="#">Profile</a>
										</li>
									...
									<ul class="submenu curency" >
										<li class="menu-item" >
											<a title="Dashboard" href="{{ route('student.dashboard') }}">Dashboard</a>
										</li>
										<li class="menu-item" >
											<a title="Profile" href="#">Profile</a>
										</li>
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="#" class="link-term mercado-item-title">Club</a>
								</li>
								<li class="menu-item">
